...
void test_thread_preandpost()
{
	...
	pthread_t t[3];
	struct targ *arg1 = (struct targ *)mem.m(sizeof(struct targ));
	struct targ *arg2 = (struct targ *)mem.m(sizeof(struct targ));
	struct targ *arg3 = (struct targ *)mem.m(sizeof(struct targ));
